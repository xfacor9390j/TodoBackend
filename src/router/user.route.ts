...
userRoute.get('/api/auth/github/redirect', passport.authenticate('github', { failureRedirect: 'https://todo-frontend-theta-one.vercel.app/',successRedirect: 'https://todo-frontend-theta-one.vercel.app/home' }), redirect)
